...
export default function BuildVersionFooter() {
  return (
    <div className="hidden md:block fixed bottom-0 right-0 text-[10px] text-muted-foreground bg-muted/30 px-3 py-1 rounded-tl-md border-t border-l border-muted-foreground/20 font-mono">
